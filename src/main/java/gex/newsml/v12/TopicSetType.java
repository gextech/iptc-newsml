 ...
 * name for the TopicSet. Its meaning and permitted values are determined by a
 * controlled vocabulary as described in the comment to the formalname attribute
 * group declaration above.
 * 
 * <p>
...
public class TopicSetType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the topicSetRef property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	public static class Topic {
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the topicType property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the formalName property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
