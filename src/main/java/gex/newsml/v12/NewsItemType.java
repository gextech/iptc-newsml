...
/**
 * A managed set of information representing a point of view, at a given time,
 * on some event or events. Its Identification and NewsManagement provide
 ...
 * 
 * <p>
 * Java class for NewsItemType complex type.
 * 
 * <p>
...
public class NewsItemType {
	 ...
	 * 
	 * @return possible object is {@link NewsItemType.Identification }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link NewsItemType.Identification }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link NewsItemType.NewsManagement }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link NewsItemType.NewsManagement }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link NewsComponentType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link NewsComponentType }
	 * 
	 */
	...
	public static class NewsManagement {
		 ...
		 * 
		 * @return possible object is {@link NewsItemType.NewsManagement.Type }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link NewsItemType.NewsManagement.Type
		 *            }
		 * 
		 */
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the statusWillChange property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
		 ...
		 * 
		 * @return possible object is {@link NewsItemType.NewsManagement.Urgency
		 *         }
		 * 
		 */
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the associatedWith property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
		...
		public static class FirstCreated {
			 ...
			 * assigned. Uses the format YYYYMMDDTHHMMSS{+or-}HHMM (year, month,
			 * day, time separator, hours, minutes, seconds, timezone separator,
			 * hours, minutes). If only the Date is needed, then the substring
			 * from T onwards may be omitted. Where the offset difference is
			 * +0000 the letter suffix "Z" may alternatively be used. This is
			 * the Basic Format defined by ISO 8601. YYYY is a 4-digit year
			 * number. MM is a 2-digit month number. DD is a 2-digit day number.
			 * T is the letter 'T'. HH is a 2-digit hour number (using a 24-hour
			 * clock). MM is a 2 digit minute number. (Note that midnight may be
			 * represented as 240000 on the date of the day that is ending, or
			 * as 000000 on the date of the day that is beginning.) {+or-} is
			 * the '+' character or the '-' character, and the following HHMM
			 * are hours and minutes of offset from Universal Co-ordinated Time
			 * (UTC) as defined by ISO 8601. If the time is being expressed in
			 * UTC, then the timezone offset may be '+0000' or '-0000'. If the
			 * time is behind UTC, the timezone separator is '-'. If the time is
			 * ahead of UTC the timezone separator is '+'. Example: 10:27 p.m.
			 * in New York on 31 December 2000 would be expressed as
			 * "20001231T222700-0500" as New York is five hours behind UTC in
			 * winter. At the same moment in London, the date and time would be
			 * expressed as "20010101T032700+0000" or as "20010101T032700-0000"
			 * because in London it is now 3:27 a.m. on 1 January 2001. At the
			 * same moment in Paris,the date and time would be expressed as
			 * "20010101T042700+0100", because Paris is one hour ahead of UTC in
			 * winter and it is now 4:27 a.m. on 1 January 2001
			 * 
			 * @return possible object is {@link String }
			 * 
			 */
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "revisionStatus" })
		public static class Instruction {
			 ...
			 * snapshot. Therefore any modification you make to the returned
			 * list will be present inside the JAXB object. This is why there is
			 * not a <CODE>set</CODE> method for the revisionStatus property.
			 * 
			 * <p>
			 * For example, to add a new item, do as follows:
			 * 
		...
		public static class StatusWillChange {
			 ...
			 * 
			 * @return possible object is {@link DateAndTimeType }
			 * 
			 */
			 ...
			 * 
			 * @param value
			 *            allowed object is {@link DateAndTimeType }
			 * 
			 */
	...
	public static class Update {
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the insertBeforeOrInsertAfterOrReplace
		 * property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
