 ...
 * certain Topics are used. The optional Href attribute provides a pointer to a
 * Catalog element elsewhere in this or another document. Its value consists of
...
public class CatalogType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the topicUse property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "urn", "url", "defaultVocabularyFor" })
	@ToString
	public static class Resource {
		 ...
		 * 
		 * @return possible object is {@link CatalogType.Resource.Urn }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link CatalogType.Resource.Urn }
		 * 
		 */
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the defaultVocabularyFor property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
