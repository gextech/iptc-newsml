...
@XmlType(name = "", propOrder = { "personOrOrgOrLocation" })
@XmlRootElement(name = "identified-content")
@ToString
public class IdentifiedContent {

	@XmlElements({ @XmlElement(name = "person", type = Person.class), @XmlElement(name = "org", type = Org.class),
			@XmlElement(name = "location", type = Location.class), @XmlElement(name = "event", type = Event.class),
	 ...
	 * <CODE>set</CODE> method for the personOrOrgOrLocation property.
	 * 
	 * <p>
	 ...
	 * {@link Org } {@link Location } {@link Event } {@link Function }
	 * {@link ObjectTitle } {@link Virtloc } {@link Classifier }
	 * 
	 * 
	 */
