...
@XmlType(name = "", propOrder = { "tobject", "keyList", "classifier", "byline", "dateline", "copyrite", "_abstract",
		"pOrHl2OrTable", "datasource", "any" })
...
public class Block {
	...
	@XmlElements({ @XmlElement(name = "p", type = P.class), @XmlElement(name = "hl2", type = Hl2.class),
			@XmlElement(name = "table", type = Table.class), @XmlElement(name = "nitf-table", type = NitfTable.class),
			@XmlElement(name = "media", type = Media.class), @XmlElement(name = "ol", type = Ol.class),
			@XmlElement(name = "ul", type = Ul.class), @XmlElement(name = "dl", type = Dl.class),
			@XmlElement(name = "bq", type = Bq.class), @XmlElement(name = "fn", type = Fn.class),
			@XmlElement(name = "note", type = Note.class), @XmlElement(name = "pre", type = Pre.class),
	 ...
	 * 
	 * @return possible object is {@link KeyList }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link KeyList }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the classifier property.
	 * 
	 * <p>
	 ...
	 * 
	 * @return possible object is {@link Byline }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link Dateline }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Dateline }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link Copyrite }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Copyrite }
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the pOrHl2OrTable property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * {@link Hl2 } {@link Table } {@link NitfTable } {@link Media } {@link Ol }
	 * {@link Ul } {@link Dl } {@link Bq } {@link Fn } {@link Note } {@link Pre
	 * } {@link Hr }
	 * 
	 * 
	 */
