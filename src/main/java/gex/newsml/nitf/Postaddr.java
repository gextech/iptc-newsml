...
@XmlType(name = "", propOrder = { "addressee", "deliveryPoint", "postcodeOrDeliveryOfficeOrRegion" })
...
public class Postaddr {
	...
	@XmlElements({ @XmlElement(name = "postcode", type = Postcode.class),
			@XmlElement(name = "delivery.office", type = DeliveryOffice.class),
			@XmlElement(name = "region", type = Region.class), @XmlElement(name = "country", type = Country.class) })
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Addressee }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link DeliveryPoint }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link DeliveryPoint }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the postcodeOrDeliveryOfficeOrRegion
	 * property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Postcode
	 * } {@link DeliveryOffice } {@link Region } {@link Country }
	 * 
	 * 
	 */
