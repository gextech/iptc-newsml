...
@XmlType(name = "", propOrder = { "blockAndCredit" })
@XmlRootElement(name = "bq")
@ToString
public class Bq {

	@XmlElements({ @XmlElement(name = "block", type = Block.class), @XmlElement(name = "credit", type = Credit.class) })
	 ...
	 * <CODE>set</CODE> method for the blockAndCredit property.
	 * 
	 * <p>
