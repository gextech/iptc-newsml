...
public class Person {
	...
	@XmlElementRefs({
			...
			@XmlElementRef(name = "name.given", namespace = "http://iptc.org/std/NITF/2006-10-18/", type = NameGiven.class, required = false),
	 ...
	 * {@link NameFamily } {@link NameGiven } {@link String } {@link AltCode }
	 * {@link Function }
	 * 
	 * 
	 */
