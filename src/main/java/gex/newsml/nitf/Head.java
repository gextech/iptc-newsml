...
@XmlType(name = "", propOrder = { "title", "meta", "tobject", "iim", "docdata", "pubdata", "revisionHistory", "any" })
...
public class Head {
	...
	/**
	 * 
	 * Partial description Document Title. Full description Often displayed
	 * within a result-list after a search finds this article.
	 * 
	 * 
	...
	/**
	 * 
	 * Partial description A construct for sending generic metadata. Full
	 * description Normally is undisplayed. Gets the value of the meta property.
	 * 
	 * <p>
	...
	/**
	 * 
	 * Partial description Subject code. Full description Used to identify the
	 * type of the news material, based on a Subject Code system.
	 * 
	 * 
	 * @return possible object is {@link Tobject }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Tobject }
	 * 
	 */
	...
	/**
	 * 
	 * Partial description IIM Record 2 Data Container. Full description
	 * Location for IIM Record 2 DataSet information.
	 * 
	 * 
	 * @return possible object is {@link Iim }
	 * 
	 */
	public Iim getIim() {
		return iim;
	...
	/**
	 * 
	 * Partial description Document metadata. Full description Container for
	 * metadata information about this particular document.
	 * 
	 * 
	 * @return possible object is {@link Docdata }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Docdata }
	 * 
	 */
	...
	/**
	 * 
	 * Partial description Information about specific instance of an item's
	 * publication. Full description Contains metadata about how the particular
	 * news object was used in a specific instance. Gets the value of the
	 * pubdata property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the pubdata property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Pubdata }
	 * 
	 * 
	 */
	...
	/**
	 * 
	 * Partial description Information about the creative history of the
	 * document; also used as an audit trail. Full description Includes who made
	 * changes, when the changes were made, and why. Gets the value of the
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the revisionHistory property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
