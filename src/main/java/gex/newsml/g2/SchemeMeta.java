...
@XmlType(name = "", propOrder = { "sameAsSchemeOrNameOrDefinition", "any" })
...
public class SchemeMeta {
	 ...
	 * <CODE>set</CODE> method for the sameAsSchemeOrNameOrDefinition property.
	 * 
	 * <p>
	 ...
	 * {@link Note } {@link FlexRelatedConceptType } {@link Flex2ExtPropType }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the concepttype property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
