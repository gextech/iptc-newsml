 ...
 * 
 * <p>
 * Java class for FlexPropType complex type.
 * 
 * <p>
...
@XmlType(name = "FlexPropType", propOrder = { "nameOrHierarchyInfo" })
@XmlSeeAlso({ SameAsType.class, RelatedConceptType.Related.class, RelatedConceptType.class,
		gex.newsml.g2.GroupSet.Group.ConceptRef.class, Facet.class })
@ToString
