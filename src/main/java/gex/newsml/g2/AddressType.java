...
@XmlType(name = "AddressType", propOrder = { "line", "locality", "area", "country", "postalCode" })
@ToString
public class AddressType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the locality property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * @return possible object is {@link Flex1PropType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Flex1PropType }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link IntlStringType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link IntlStringType }
	 * 
	 */
	...
	@XmlType(name = "")
	@ToString
	public static class Line extends IntlStringType {
