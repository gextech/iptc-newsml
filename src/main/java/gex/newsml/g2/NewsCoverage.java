...
@XmlType(name = "", propOrder = { "planning", "delivery", "newsCoverageExtProperty", "any" })
...
public class NewsCoverage {
	 ...
	 * <CODE>set</CODE> method for the planning property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the newsCoverageExtProperty property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "g2ContentType", "itemClass", "itemCount", "assignedTo", "scheduled", "service",
			"languageOrGenreOrKeyword", "edNote", "newsContentCharacteristics", "planningExtProperty", "any" })
	@ToString
	public static class Planning {
		 ...
		 * 
		 * @return possible object is {@link NewsCoverage.Planning.G2ContentType
		 *         }
		 * 
		 */
		...
		/**
		 * The nature of the G2 item, set in accordance with the structure of
		 * its content.
		 * 
		 ...
		 * 
		 * @return possible object is {@link NewsCoverage.Planning.ItemCount }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link NewsCoverage.Planning.ItemCount }
		 * 
		 */
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the planningExtProperty property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
		...
		@XmlType(name = "")
		@ToString
		public static class AssignedTo extends Flex1PartyPropType {
