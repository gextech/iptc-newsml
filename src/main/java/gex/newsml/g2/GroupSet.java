...
@ToString public class GroupSet {
    ...
    @ToString public static class Group {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the groupRefOrItemRefOrConceptRef property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         ...
         * {@link JAXBElement }{@code <}{@link GroupSet.Group.GroupRef }{@code >}
         * {@link JAXBElement }{@code <}{@link Link1Type }{@code >}
         * {@link Signal }
         * {@link JAXBElement }{@code <}{@link GroupSet.Group.ConceptRef }{@code >}
