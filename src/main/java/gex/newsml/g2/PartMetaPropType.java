 ...
 * 
 * <p>
 * Java class for partMetaPropType complex type.
 * 
 * <p>
...
@XmlType(name = "partMetaPropType", propOrder = { "icon", "timeDelim", "regionDelim", "role", "urgency",
		"contentCreated", "contentModified", "locatedOrInfoSourceOrCreator", "languageOrGenreOrKeyword",
		"partMetaExtProperty", "signal", "edNote", "link", "any" })
@ToString
public class PartMetaPropType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the timeDelim property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * @return possible object is {@link PartMetaPropType.RegionDelim }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link PartMetaPropType.RegionDelim }
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the partMetaExtProperty property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the contentrefs property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
