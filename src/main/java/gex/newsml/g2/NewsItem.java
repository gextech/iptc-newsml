 ...
 *         &lt;element ref="{http://iptc.org/std/nar/2006-10-01/}contentSet" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = { "contentMeta", "partMeta", "_assert", "inlineRef", "derivedFrom", "contentSet" })
@XmlRootElement(name = "newsItem")
@ToString
public class NewsItem extends AnyItemType {
	...
	protected ContentSet contentSet;
	 ...
	 * 
	 * @return possible object is {@link ContentSet }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ContentSet }
	 * 
	 */
	public void setContentSet(ContentSet value) {
