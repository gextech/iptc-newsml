...
@XmlSeeAlso({ gex.newsml.g2.NewsMessage.Header.Sender.class, gex.newsml.g2.NewsMessage.Header.Origin.class,
		gex.newsml.g2.NewsMessage.Header.Destination.class, gex.newsml.g2.NewsMessage.Header.Channel.class })
@ToString
