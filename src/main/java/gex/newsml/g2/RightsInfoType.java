...
/**
 * The type for a set of properties representing the rights associated with the
 * Item (Type defined in this XML Schema only)
 * 
 * <p>
 * Java class for RightsInfoType complex type.
 * 
 * <p>
...
@XmlType(name = "RightsInfoType", propOrder = { "accountable", "copyrightHolder", "copyrightNoticeOrUsageTermsOrLink",
		"any" })
@ToString
public class RightsInfoType {
	 ...
	 * 
	 * @return possible object is {@link FlexPersonPropType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link FlexPersonPropType }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the copyrightNoticeOrUsageTermsOrLink
	 * property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the scopeuri property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the aspect property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the aspecturi property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
