...
public class HopHistory {
	 ...
	 * <CODE>set</CODE> method for the hop property.
	 * 
	 * <p>
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "party", "action" })
	@ToString
	public static class Hop {
		 ...
		 * 
		 * @return possible object is {@link HopHistory.Hop.Party }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link HopHistory.Hop.Party }
		 * 
		 */
		...
		@XmlType(name = "")
		@ToString
		public static class Action extends QualPropType {
		...
		@XmlType(name = "")
		@ToString
		public static class Party extends FlexPartyPropType {
