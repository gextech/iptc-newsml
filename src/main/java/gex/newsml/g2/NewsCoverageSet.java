 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://iptc.org/std/nar/2006-10-01/}newsCoverage" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = { "newsCoverage" })
...
public class NewsCoverageSet {
	...
	/**
	 * Gets the value of the newsCoverage property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the newsCoverage property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getNewsCoverage().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * 
	 */
	public List<NewsCoverage> getNewsCoverage() {
		if (newsCoverage == null) {
			newsCoverage = new ArrayList<NewsCoverage>();
		}
		return this.newsCoverage;
	}
