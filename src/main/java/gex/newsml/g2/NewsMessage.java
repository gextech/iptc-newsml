...
public class NewsMessage {
    ...
    public static class Header {
        ...
        @XmlElements({
            @XmlElement(name = "catalogRef", type = NewsMessage.Header.CatalogRef.class),
        ...
        @XmlElements({
            @XmlElement(name = "timestamp", type = NewsMessage.Header.Timestamp.class),
         ...
         * {@link NewsMessage.Header.CatalogRef }
         * {@link Catalog }
         * 
         * 
         */
         ...
         * @return
         *     possible object is
         *     {@link NewsMessage.Header.Sender }
         *     
         */
         ...
         * @return
         *     possible object is
         *     {@link NewsMessage.Header.Priority }
         *     
         */
         ...
         * @return
         *     possible object is
         *     {@link NewsMessage.Header.Origin }
         *     
         */
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the timestampOrDestinationOrChannel property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         ...
         * {@link NewsMessage.Header.Channel }
         * {@link Signal }
