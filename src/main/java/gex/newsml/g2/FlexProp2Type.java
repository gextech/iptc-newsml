 ...
 * 
 * <p>
 * Java class for FlexProp2Type complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="FlexProp2Type">
 *   &lt;complexContent>
...
@XmlType(name = "FlexProp2Type", propOrder = { "nameOrHierarchyInfoOrSameAs" })
@XmlSeeAlso({ FlexRelatedPropType.class })
@ToString
public class FlexProp2Type {
	...
	protected List<Object> nameOrHierarchyInfoOrSameAs;
	...
	/**
	 * Gets the value of the nameOrHierarchyInfoOrSameAs property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the nameOrHierarchyInfoOrSameAs property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getNameOrHierarchyInfoOrSameAs().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link ConceptNameType } {@link HierarchyInfo } {@link SameAsType }
	 * 
	 * 
	 */
	public List<Object> getNameOrHierarchyInfoOrSameAs() {
		if (nameOrHierarchyInfoOrSameAs == null) {
			nameOrHierarchyInfoOrSameAs = new ArrayList<Object>();
		}
		return this.nameOrHierarchyInfoOrSameAs;
	}
