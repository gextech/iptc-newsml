...
@XmlType(name = "", propOrder = { "title", "scheme" })
...
public class Catalog {
	...
	/**
	 * A short natural language name for the Catalog.Gets the value of the title
	 * property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the scheme property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "sameAsSchemeOrNameOrDefinition" })
	@ToString
	public static class Scheme {

		@XmlElements({ @XmlElement(name = "sameAsScheme", type = SameAsScheme.class),
		 ...
		 * <CODE>set</CODE> method for the sameAsSchemeOrNameOrDefinition
		 * property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 ...
		 * <p>
		 * Objects of the following type(s) are allowed in the list
		 * {@link SameAsScheme } {@link ConceptNameType } {@link Definition }
		 * {@link Note } {@link Catalog.Scheme.SameAs }
		 * 
		 * 
		 */
		...
		public static class SameAs {
			...
			/**
			 * The type of an Internationalized Resource Identifier Reference,
			 * as defined in RFC 3987. Identical to xs : anyURI.
			 * 
			 * @return possible object is {@link String }
			 * 
			 */
