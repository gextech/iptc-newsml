 ...
 * 
 * <p>
 * Java class for RelatedConceptType complex type.
 * 
 * <p>
...
@XmlType(name = "RelatedConceptType", propOrder = { "facetOrRelatedOrSameAs" })
@XmlSeeAlso({ FlexRelatedConceptType.class })
@ToString
public class RelatedConceptType extends FlexPropType {

	@XmlElements({ @XmlElement(name = "facet", type = Facet.class),
	 ...
	 * <CODE>set</CODE> method for the facetOrRelatedOrSameAs property.
	 * 
	 * <p>
	 ...
	 * {@link RelatedConceptType.Related } {@link SameAsType }
	 * 
	 * 
	 */
	...
	@XmlType(name = "")
	@ToString
	public static class Related extends FlexPropType {
