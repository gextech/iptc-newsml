 ...
 * 
 * <p>
 * Java class for ContentMetadataAcDType complex type.
 * 
 * <p>
...
@XmlType(name = "ContentMetadataAcDType", propOrder = { "icon", "urgency", "contentCreated", "contentModified",
		"locatedOrInfoSourceOrCreator", "languageOrKeywordOrSubject", "contentMetaExtProperty", "any" })
@ToString
public class ContentMetadataAcDType {
	...
	@XmlElements({ @XmlElement(name = "language", type = Language.class),
			@XmlElement(name = "keyword", type = Keyword.class), @XmlElement(name = "subject", type = Subject.class),
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the languageOrKeywordOrSubject property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * } {@link Keyword } {@link Subject } {@link Slugline } {@link Headline }
	 * {@link Description }
	 * 
	 * 
	 */
