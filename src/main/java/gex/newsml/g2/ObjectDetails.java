...
@XmlType(name = "", propOrder = { "created", "copyrightNoticeOrCreator", "ceasedToExist", "any" })
@XmlRootElement(name = "objectDetails")
@ToString
public class ObjectDetails {

	protected TruncatedDateTimePropType created;
	@XmlElements({ @XmlElement(name = "copyrightNotice", type = RightsBlockType.class),
	 ...
	 * <CODE>set</CODE> method for the copyrightNoticeOrCreator property.
	 * 
	 * <p>
	 ...
	 * {@link RightsBlockType } {@link FlexAuthorPropType }
	 * 
	 * 
	 */
