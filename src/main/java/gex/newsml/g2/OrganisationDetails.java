...
@XmlType(name = "", propOrder = {
    "founded",
    "dissolved",
    "locationOrContactInfoOrHasInstrument",
    "any"
})
...
@ToString public class OrganisationDetails {
     ...
     * This is why there is not a <CODE>set</CODE> method for the locationOrContactInfoOrHasInstrument property.
     * 
     * <p>
    ...
    @ToString public static class HasInstrument {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the typeuri property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
