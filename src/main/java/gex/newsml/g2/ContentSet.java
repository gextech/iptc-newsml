...
@XmlType(name = "", propOrder = { "inlineXMLOrInlineDataOrRemoteContent" })
@XmlRootElement(name = "contentSet")
@ToString
public class ContentSet {

	@XmlElements({ @XmlElement(name = "inlineXML", type = ContentSet.InlineXML.class),
	 ...
	 * <CODE>set</CODE> method for the inlineXMLOrInlineDataOrRemoteContent
	 * property.
	 * 
	 * <p>
	 ...
	 * {@link ContentSet.InlineXML } {@link ContentSet.InlineData }
