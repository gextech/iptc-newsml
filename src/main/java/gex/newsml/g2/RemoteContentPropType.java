...
import gex.newsml.g2.reuters.ReutersAltId;

/**
 * A type representing the structure of the remoteContent property
 * 
 * <p>
 * Java class for RemoteContentPropType complex type.
 * 
 * <p>
...
@XmlType(name = "RemoteContentPropType", propOrder = { "channel", "altId", "altLoc", "hash", "signal",
		"remoteContentExtProperty", "reutersAltId", "any" })
@ToString
public class RemoteContentPropType {
	...
	@XmlElement(name = "altId", namespace = "http://www.reuters.com/ns/2003/08/content")
	protected List<ReutersAltId> reutersAltId;
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the altId property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link AltId }
	 *
	 *
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the altLoc property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link AltLoc }
	 *
	 *
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the remoteContentExtProperty property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	/**
	 * @return the reutersAltId
	 */
	public List<ReutersAltId> getReutersAltId() {
		return reutersAltId;
	}

	/**
	 * @param reutersAltId
	 *            the reutersAltId to set
	 */
	public void setReutersAltId(List<ReutersAltId> reutersAltId) {
		this.reutersAltId = reutersAltId;
	}
