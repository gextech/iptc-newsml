 ...
 * 
 * <p>
 * Java class for FlexPartyPropType complex type.
 * 
 * <p>
...
@XmlType(name = "FlexPartyPropType", propOrder = { "nameOrDefinitionOrNote", "sameAsOrBroaderOrNarrower",
		"personDetails", "organisationDetails", "any" })
@XmlSeeAlso({ FlexAuthorPropType.class, gex.newsml.g2.HopHistory.Hop.Party.class, Flex1PartyPropType.class })
@ToString
