...
/**
 * Flexible location (geopolitical area of point-of-interest) data type for both
 * controlled and uncontrolled values
 * 
 * <p>
 * Java class for FlexLocationPropType complex type.
 * 
 * <p>
...
@XmlType(name = "FlexLocationPropType", propOrder = { "nameOrDefinitionOrNote", "sameAsOrBroaderOrNarrower",
		"geoAreaDetails", "poiDetails", "any" })
@XmlSeeAlso({ gex.newsml.g2.EventDetails.Location.class, OrganisationLocationType.class })
@ToString
