 ...
 * 
 * <p>
 * Java class for ApproximateDateTimePropType complex type.
 * 
 * <p>
...
@XmlType(name = "ApproximateDateTimePropType", propOrder = { "value" })
@ToString
public class ApproximateDateTimePropType {

	@XmlValue
	protected String value;
	@XmlAttribute(name = "approxstart")
	protected String approxstart;
	@XmlAttribute(name = "approxend")
