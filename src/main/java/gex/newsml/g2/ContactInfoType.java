...
/**
 * The type for information to get in contact with a party (Type defined in this
 * XML Schema only)
 * 
 * <p>
 ...
 *             &lt;/complexType>
 *           &lt;/element>
 *           &lt;element name="address" type="{http://iptc.org/std/nar/2006-10-01/}AddressType"/>
...
@XmlType(name = "ContactInfoType", propOrder = { "emailOrImOrPhone", "any" })
@ToString
public class ContactInfoType {

	@XmlElementRefs({
			@XmlElementRef(name = "fax", namespace = "http://iptc.org/std/nar/2006-10-01/", type = JAXBElement.class, required = false),
			@XmlElementRef(name = "web", namespace = "http://iptc.org/std/nar/2006-10-01/", type = JAXBElement.class, required = false),
			@XmlElementRef(name = "note", namespace = "http://iptc.org/std/nar/2006-10-01/", type = Note.class, required = false),
			@XmlElementRef(name = "phone", namespace = "http://iptc.org/std/nar/2006-10-01/", type = JAXBElement.class, required = false),
			@XmlElementRef(name = "im", namespace = "http://iptc.org/std/nar/2006-10-01/", type = JAXBElement.class, required = false),
			@XmlElementRef(name = "email", namespace = "http://iptc.org/std/nar/2006-10-01/", type = JAXBElement.class, required = false),
			@XmlElementRef(name = "address", namespace = "http://iptc.org/std/nar/2006-10-01/", type = JAXBElement.class, required = false) })
	 ...
	 * <CODE>set</CODE> method for the emailOrImOrPhone property.
	 * 
	 * <p>
	 ...
	 * {@link Note } {@link JAXBElement }{@code <}
	 * {@link ElectronicAddressTechType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ElectronicAddressTechType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ElectronicAddressType }{@code >} {@link JAXBElement }{@code <}
	 * {@link AddressType }{@code >}
	 * 
	 * 
	 */
