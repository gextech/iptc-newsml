...
/**
 * The type of a calendar date with an optional time part which may be truncated
 * from the seconds part to the month part
 * 
 * <p>
 * Java class for TruncatedDateTimePropType complex type.
 * 
 * <p>
...
@XmlType(name = "TruncatedDateTimePropType", propOrder = { "value" })
@ToString
public class TruncatedDateTimePropType {
	...
	/**
	 * The type of a calendar date with an optional time part which may be
	 * truncated from the second part to the month part
	 * 
