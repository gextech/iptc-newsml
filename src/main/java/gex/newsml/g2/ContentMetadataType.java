 ...
 * 
 * <p>
 * Java class for ContentMetadataType complex type.
 * 
 * <p>
...
@XmlType(name = "ContentMetadataType", propOrder = { "icon", "urgency", "contentCreated", "contentModified",
		"locatedOrInfoSourceOrCreator", "contentMetaExtProperty", "any" })
@ToString
