...
/**
 * The type for a set of properties directly associated with the item (Type
 * defined in this XML Schema only)
 * 
 * <p>
 * Java class for ItemMetadataType complex type.
 * 
 * <p>
...
@XmlType(name = "ItemMetadataType", propOrder = { "itemClass", "provider", "versionCreated", "firstCreated",
		"embargoed", "pubStatus", "role", "fileName", "generator", "profile", "service", "title", "edNote", "memberOf",
		"instanceOf", "signal", "altRep", "deliverableOf", "hash", "expires", "origRep", "incomingFeedId", "link",
		"itemMetaExtProperty", "any" })
@ToString
public class ItemMetadataType {
	 ...
	 * 
	 * @return possible object is {@link FlexPartyPropType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link FlexPartyPropType }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link DateTimeOrNullPropType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link DateTimeOrNullPropType }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link FileName }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link FileName }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link VersionedStringType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link VersionedStringType }
	 * 
	 */
	...
	/**
	 * A short natural language name for the Item.Gets the value of the title
	 * property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link BlockType
	 * }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the memberOf property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the instanceOf property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the altRep property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link AltRep }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the deliverableOf property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Link1Type
	 * }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the hash property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Hash }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the expires property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the origRep property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link OrigRep }
	 * 
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the incomingFeedId property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the itemMetaExtProperty property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
